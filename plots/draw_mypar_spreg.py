...
if __name__ == "__main__":
    ...
    for thread in threads:
        with open(f"{BASE_PATH}/SABLE/results/benchmarks_spmm_{thread}.csv", "r") as f:
            ...
            for line in lines:
                ...
                if name.endswith("_0_nonuniform"):  # Use elif for non-uniform
    ...
    plt.savefig("parspmm_nonuniform.pdf")
