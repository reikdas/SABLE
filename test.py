...
# ---------------------------------------------------------------------------
# SpMV — old codegen (vbr_spmv_codegen): naive dense + SpV8/MKL sparse
# ---------------------------------------------------------------------------

def test_spmv_naive_spv8():
...
def test_spmv_unroll_naive_spv8():
...
# ---------------------------------------------------------------------------
# SpMV — naive sparse dispatch
# ---------------------------------------------------------------------------

def test_spmv_naive_naive_fullsparse():
    """Test gen_single_threaded_spmv_naive_naive against scipy SpMV (fully sparse, no dense blocks)."""
...
# ---------------------------------------------------------------------------
# SpMV — UZP sparse dispatch
# ---------------------------------------------------------------------------

def test_spmv_naive_uzp():
...
# ---------------------------------------------------------------------------
# SpMM — old codegen (vbr_spmm_codegen): naive dense, naive sparse
# ---------------------------------------------------------------------------

def test_spmm_naive_only_dense():
    run_spmm(1)

def test_spmm_unroll_naive_naive():
    run_spmm_unroll(1)


# ---------------------------------------------------------------------------
# SpMM — naive sparse dispatch
# ---------------------------------------------------------------------------
