...
int main(void) {
    ...
    int *_interp_vbr_val_spmm_naive_block_r0 = (int *)malloc(2 * sizeof(int));
    assert(_interp_vbr_val_spmm_naive_block_r0 != NULL);
    int *_interp_vbr_val_spmm_naive_block_r1 = (int *)malloc(2 * sizeof(int));
    assert(_interp_vbr_val_spmm_naive_block_r1 != NULL);
    int *_interp_vbr_val_spmm_naive_block_c0 = (int *)malloc(2 * sizeof(int));
    assert(_interp_vbr_val_spmm_naive_block_c0 != NULL);
    int *_interp_vbr_val_spmm_naive_block_c1 = (int *)malloc(2 * sizeof(int));
    assert(_interp_vbr_val_spmm_naive_block_c1 != NULL);
    int *_interp_vbr_val_spmm_naive_block_offset = (int *)malloc(2 * sizeof(int));
    assert(_interp_vbr_val_spmm_naive_block_offset != NULL);
    int *_interp_vbr_val_spmm_naive_block_nrhs = (int *)malloc(2 * sizeof(int));
    assert(_interp_vbr_val_spmm_naive_block_nrhs != NULL);
    ...
    read_int_array(matrix_file, _interp_vbr_val_spmm_naive_block_r0, 2);
    read_int_array(matrix_file, _interp_vbr_val_spmm_naive_block_r1, 2);
    read_int_array(matrix_file, _interp_vbr_val_spmm_naive_block_c0, 2);
    read_int_array(matrix_file, _interp_vbr_val_spmm_naive_block_c1, 2);
    read_int_array(matrix_file, _interp_vbr_val_spmm_naive_block_offset, 2);
    read_int_array(matrix_file, _interp_vbr_val_spmm_naive_block_nrhs, 2);
    fclose(matrix_file);
...
for (int _interp_s = 0; _interp_s < 2; _interp_s++) {
    vbr_val_spmm_naive_block(y, x, vbr_val, _interp_vbr_val_spmm_naive_block_r0[_interp_s], _interp_vbr_val_spmm_naive_block_r1[_interp_s], _interp_vbr_val_spmm_naive_block_c0[_interp_s], _interp_vbr_val_spmm_naive_block_c1[_interp_s], _interp_vbr_val_spmm_naive_block_offset[_interp_s], _interp_vbr_val_spmm_naive_block_nrhs[_interp_s]);
}
        clock_gettime(CLOCK_MONOTONIC, &t2);
    ...
    free(_interp_vbr_val_spmm_naive_block_r0);
    free(_interp_vbr_val_spmm_naive_block_r1);
    free(_interp_vbr_val_spmm_naive_block_c0);
    free(_interp_vbr_val_spmm_naive_block_c1);
    free(_interp_vbr_val_spmm_naive_block_offset);
    free(_interp_vbr_val_spmm_naive_block_nrhs);
