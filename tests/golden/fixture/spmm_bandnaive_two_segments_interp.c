...
int main(void) {
    ...
    int *_interp_vdia_val_spmm_naive_segment_row0 = (int *)malloc(2 * sizeof(int));
    assert(_interp_vdia_val_spmm_naive_segment_row0 != NULL);
    int *_interp_vdia_val_spmm_naive_segment_nrows = (int *)malloc(2 * sizeof(int));
    assert(_interp_vdia_val_spmm_naive_segment_nrows != NULL);
    int *_interp_vdia_val_spmm_naive_segment_ndiags = (int *)malloc(2 * sizeof(int));
    assert(_interp_vdia_val_spmm_naive_segment_ndiags != NULL);
    int *_interp_vdia_val_spmm_naive_segment_idiag_off = (int *)malloc(2 * sizeof(int));
    assert(_interp_vdia_val_spmm_naive_segment_idiag_off != NULL);
    int *_interp_vdia_val_spmm_naive_segment_val_off = (int *)malloc(2 * sizeof(int));
    assert(_interp_vdia_val_spmm_naive_segment_val_off != NULL);
    int *_interp_vdia_val_spmm_naive_segment_nrhs = (int *)malloc(2 * sizeof(int));
    ...
    read_int_array(matrix_file, _interp_vdia_val_spmm_naive_segment_row0, 2);
    read_int_array(matrix_file, _interp_vdia_val_spmm_naive_segment_nrows, 2);
    read_int_array(matrix_file, _interp_vdia_val_spmm_naive_segment_ndiags, 2);
    read_int_array(matrix_file, _interp_vdia_val_spmm_naive_segment_idiag_off, 2);
    read_int_array(matrix_file, _interp_vdia_val_spmm_naive_segment_val_off, 2);
    read_int_array(matrix_file, _interp_vdia_val_spmm_naive_segment_nrhs, 2);
    fclose(matrix_file);
