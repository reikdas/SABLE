...
int main(void) {
    ...
    double *x = (double *)malloc(11 * sizeof(double));
    assert(y != NULL);
    assert(x != NULL);
    ...
    read_dense_input(rhs_file, x, 11);
    fclose(rhs_file);

char csr_indptr_mtx_path[] = "csr_indptr_input_755a2d97258c.mtx";
char csr_indptr_uzp_dir[] = "csr_indptr_tmp_755a2d97258c";
write_csr_matrix_market(csr_indptr_mtx_path, 11, 11, 6,
...
snprintf(csr_indptr_path, sizeof(csr_indptr_path), "%s/csr_indptr_input_755a2d97258c.tuned.uzp",
    csr_indptr_uzp_dir);
...
cblas_dgemv(CblasColMajor, CblasNoTrans,
    ...
    &y[3], 1);
        ...
        clock_gettime(CLOCK_MONOTONIC, &t1);
spf_executors_spf_matrix_dense_vector_product(csr_indptr_spf_mat, x, y, 11, 11, 0);
        clock_gettime(CLOCK_MONOTONIC, &t2);
