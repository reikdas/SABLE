...
char csr_indptr_mtx_path[] = "csr_indptr_input_c290d3eaab6f.mtx";
char csr_indptr_uzp_dir[] = "csr_indptr_tmp_c290d3eaab6f";
write_csr_matrix_market(csr_indptr_mtx_path, 6, 6, 12,
...
snprintf(csr_indptr_path, sizeof(csr_indptr_path), "%s/csr_indptr_input_c290d3eaab6f.tuned.uzp",
    csr_indptr_uzp_dir);
