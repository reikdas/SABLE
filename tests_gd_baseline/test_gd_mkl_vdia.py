...
from sable.kernels import GradientDescent, MKLCSRSpmv
...
def test_gd_spmv_vdia_mkl_baseline(matrix_name):
    """Gradient descent with the whole SpMV as MKL CSR; hits the iteration cap unconverged."""
